 ...
 * @link https://lokalise.com/api2docs/curl/#resource-providers
 */
class TranslationProviders extends Endpoint implements EndpointInterface
{

    /**
     * @link https://lokalise.com/api2docs/curl/#transition-list-all-providers-get
     *
     * @param int $teamId
    ...
    /**
     * @link https://lokalise.com/api2docs/curl/#transition-retrieve-a-provider-get
     *
     * @param int $teamId
